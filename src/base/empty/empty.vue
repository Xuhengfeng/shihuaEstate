 ...
 * @Last Modified time: 2018-06-07 18:04:16
 */
<template>
    <!-- 所有的空页面 -->
    <div class="empty" v-show="isEmpty">
        ...
        <div class="two" v-show="isShow">
            ...
            <div class="btn" @click="clickme()">{{btns}}</div>
        </div>
    </div>
</template>
...
export default {
    props: {
        ...
        contents: {//控制content
            type: String,
            default: '有想要约看的房源?直接在房源页面点击"预约看房"即可将房源加入待看清单,然后在这里安排你的看房行程。',
        },
        btns: {//控制btn的内容
            type: String,
            default: ''
    ...
    created() {
        let num = this.picnum;
        switch(num){
            case  1: this.picpath = require('./imgs/comment.png');break;//评论 
