<template>
	<div class="home">
		<div class="header">
			...
			<div class="container">
				<div class="fl">
					...
					<div class="city-change " v-if="cityChange">
						...
						<div class="title">选择城市
							...
							<router-link tag="a" to="">北京</router-link>
							<router-link tag="a" to="">上海</router-link>
							<router-link tag="a" to="">深圳</router-link>
							</span>
						</div>
						...
						<div class="fc-main clear">
							<div class="fl citys-l">
								<ul>
									...
									<router-link tag="li" class="clear">
									...
									<li class="clear">
										...
										<div class="city-enum fl">
											<router-link tag="a" to="">昆明</router-link>
										</div>
									</li>
								</ul>
							</div>
				...
				<div class="navmenu fr">
					<ul class="item1">
						<li>
							...
							<div v-else>
								<i class="iconfont icon-yonghu"></i>
								<span class="login">xxxx</span> /
								<span class="logout" @click="logout()">退出</span>
							</div>
						</li>
						<!--账号密码登陆-->
						<div class="panel_login " id="dialog" v-if="loginshow">
							<div class="panel_info">
								<i class="close_login" @click="cancelShadow()">×</i>

								<div class="panel_tab" v-if="loginshow == 1">
								...
								<div class="panel_tab" v-if="loginshow == 2">
								...
								<div class="panel_tab" v-if="loginshow == 3">
								...
								<div class="panel_tab" v-if="loginshow == 4">
				...
				<div class="search-box-wrap">
					<div class="search-hd" >
						<span @click="searchPlaceholder(1)">二手房</span>
						<span @click="searchPlaceholder(2)">租房</span>
						<span @click="searchPlaceholder(3)">小区</span>
					</div>
					<div class="search-bd">
		...
		<div class="statistics">
			<div class="container">
				<div>
					<p class="price">5000,00 <span>元</span></p>
					<p>全市一月均价</p>
				</div>
				<div>
					<p class="number">500,000 <span>套</span></p>
					<p>世华一月份成交量</p>
				</div>
			</div>
		</div>
		...
		<div class="section bgColor2" id="purchaseGuide">
			<div class="container">
				<div class="goods-hd">
					<span class="twohandhouse">小区</span>
		...
		<div class="section bgColor3">
			<div class="container">
				<div class="goods-hd">
					<span class="twohandhouse">品质租房</span>
					<span class="foryouselect">时尚生活</span>
					<span class="morehouse fr"><router-link tag="li" to="">更多二手好房</router-link></span>
				</div>
				<div class="goods-bd">
					<ul>
		...
		<div class="section bgColor4" id="purchaseGuide">
			<div class="container">
				<div class="goods-hd">
					<span class="twohandhouse">购房指南</span>
...
.navmenu .item1 li:not(:nth-of-type(1)):hover{
	color: #ff4343;
}
